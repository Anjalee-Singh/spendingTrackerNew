// library for calendar validation
...
function populateYears() {
  ...
  // Make this year and the 200 years before it available in the <select>
  daySelect.options = Array.from({ length: 200 }, function(index) {
    return index + year;
  });
}
